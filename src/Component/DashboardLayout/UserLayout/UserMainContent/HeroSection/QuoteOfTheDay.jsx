...
const QuoteOfTheDay = () => {
  ...
  return (
    <div className="h-full hidden md:block overflow-hidden relative border border-gray-400 dark:border-darkDevider p-4">
      ...
      <span className="absolute -top-[6rem] -right-[10rem] h-60 w-60 rounded-full outline dark:outline-gray-700 outline-gray-200"></span>
      <span className="absolute -top-[8rem] -right-[8rem] h-60 w-60 rounded-full outline dark:outline-gray-300 outline-gray-600"></span>
    </div>
  );
};
