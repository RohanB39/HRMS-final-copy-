...
import { Pagination, Empty } from "antd"; // Import Empty from Ant Design
import { employeeTotalDetails } from "../../../../../../../Redux/thunks/employeeTotalDetails";
import { useDispatch, useSelector } from "react-redux";

const AllLeavesHistory = () => {
  ...
  const currentPageData = leaveApplications.slice(startIndex, startIndex + pageSize);
            ...
            {leaveApplications.length === 0 ? (
              ...
              currentPageData.map((item, index) => (
                <tr
                  ...
                  className={`text-center ${item.status === "Pending"
                    ? "dark:bg-darknavbarBg bg-gray-50"
                    : ""
                    }`}
                >
...
export default AllLeavesHistory;
